...
//Constructor
Nivel2::Nivel2(GestorRecursos* gestor)
    : gestorRecursos(gestor), indiceActual(0) {}

void Nivel2::initNivel2() {
    ...
    if (imagenes.empty()) {//cargar la imagen y ponerla en el arreglo.
        cargarImagenes("FondoNivel2", "Imagenes/Niveles/BGN2.png");
    }
    imagenes.push_back("FondoNivel2");
}

void Nivel2::renderizarNivel2() {
...
void Nivel2::cargarImagenes(const std::string& nombre1, const std::string& ruta1) {
